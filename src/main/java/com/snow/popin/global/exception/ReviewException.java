...
public class ReviewException extends RuntimeException {
    ...
    // 리뷰 작성 권한이 없는 경우 (예: 팝업이 종료됨)
    public static class ReviewNotAllowed extends ReviewException {
        public ReviewNotAllowed(String reason) {
            super(String.format("리뷰 작성이 허용되지 않습니다: %s", reason));
        }
    }
}
