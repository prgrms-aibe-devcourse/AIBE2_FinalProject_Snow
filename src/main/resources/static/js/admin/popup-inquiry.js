// /js/admin/popup-inquiry.js

class PopupInquiryManager {
    constructor() {
        this.currentPage = 0;
        this.pageSize = 20;
        this.currentStatus = '';
        this.currentSearch = '';
        this.targetType = 'POPUP';
    ...
    async loadStats() {
        try {
            ...
            document.getElementById('totalCount').textContent = data.popup || 0;
            document.getElementById('pendingCount').textContent = data.popupPending || 0;
        } catch (error) {
    ...
    renderDetailModal(inquiry) {
        ...
        modalBody.innerHTML = `
            ...
            <div class="detail-section">
                ...
                <div class="detail-info">
                    <div class="info-item">
                        <span class="info-label">팝업명</span>
                        <span class="info-value">${inquiry.targetTitle || '삭제된 팝업'}</span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">팝업 ID</span>
...
// 전역 변수로 인스턴스 생성
let popupInquiryManager;

// DOM이 로드되면 초기화
document.addEventListener('DOMContentLoaded', function() {
    popupInquiryManager = new PopupInquiryManager();
});